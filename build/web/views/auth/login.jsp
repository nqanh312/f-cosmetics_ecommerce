            ...
            <div class="w-[600px] px-12 py-20 rounded-[10px]" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
                <form class="w-full" method="POST" action="/login">
                    ...
                    <div class="mb-6 w-full">
                        ...
                        <input type="text" name="username" id="username" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="fcosmetics@gmail.com" required>
                    </div>
                    <div class="mb-6 w-full">
                    ...
                    <div class="flex items-baseline justify-between mt-4">
                        ...
                        <div>
                            ...
                            <span>/</span>
                            <a href="/#" class="text-sm text-blue-600 hover:underline">Go to homepage</a>
                        </div>
                    </div>
                </form>
