    ...
    <body>
                        ...
                        <div>
                            <div class="flex justify-center items-center">
                                <form action="/admin/products/edit" style="min-width: 500px" id="form-product-edit">
                                    ...
                                    <div class="mb-6">
                                        <input id="isDelete" name="isDelete" value="true" aria-describedby="isDelete" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500">
                                        <label for="isDelete" class="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">is delete</label>
                                    </div>
                                            ...
                                            <div class="mb-4" id="image-item-${image.id}">
                                                <div class="max-w-[150px] bg-white rounded-lg border border-gray-200 shadow-md">
                                                    ...
                                                    <div class="flex flex-col items-center">
                                                        <img class="mb-3 w-full h-full" src="${image.image}" alt="Product image"/>
                                                    </div>
                                                </div>
                                            </div>
                                        </c:forEach>
        ...
        <script>
            ...
            $("#id").val(${product.id})
                    ...
                    $("#isDelete").prop('checked', ${product.isDelete});
            new_editor.setData(`${product.content}`)
