<%-- 
    Document   : profile
    Created on : Jun 22, 2022, 6:42:13 PM
    Author     : LENOVO
--%>
    ...
    <body>
            ...
            <form action="/admin/users/edit" method="post" id="form-profile-edit">
                ...
                <div class="mb-6">
                    <div class="flex items-center">
                        ...
                        <label for="isSuper" class="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">Is Admin</label>
                    </div>
                </div>
                        
                        <div class="mb-6">
                    <div class="flex items-center">
                        <input id="isSuper" name="isDelete" aria-describedby="checkbox-1" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500" <%=user.isIs_active()? "checked" : ""%>>
                        <label for="isDelete" class="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">Is Active</label>
                    </div>
                </div>
        ...
        <script>
            ...
            id: $("input[name='id']").val(),
                    ...
                    isDelete: $("input[name='isDelete']").is(":checked"),
