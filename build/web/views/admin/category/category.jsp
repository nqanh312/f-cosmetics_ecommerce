                            ...
                            <div class="flex flex-col items-center pb-5">
                                ...
                                <div class="flex mt-4 space-x-3">
                                    <a href="/admin/category/edit?id=${category.getId()}" class="inline-flex items-center py-2 px-4 text-sm font-medium text-center text-gray-900 bg-white rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-blue-300">Edit</a>
                                        <a onclick="return confirm('Are you sure you want to delete this category?\n\nNote: Cannot be deleted if there are still products that exist in this category group!');" href="/admin/category/delete?id=${category.getId()}" class="inline-flex items-center py-2 px-4 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:ring-blue-300">Delete</a>
                                    <input type="button" onclick="ConfirmDelete()">
                                                    <script>
                                                        function ConfirmDelete()
                                                        {
                                                          var x = confirm("Are you sure you want to delete this category?\n\n Note: Cannot be deleted if there are still products that exist in this category group!");
                                                          if (x)
                                                              return true;
                                                          else
                                                            return false;
