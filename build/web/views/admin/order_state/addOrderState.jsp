...
<html>
    ...
    <body>
        <div class="flex">
            ...
            <div class="w-full px-10 py-5">
                ...
                <div class="flex justify-center items-center" style="height: 80vh">
                    <form action="/admin/order/state/add" style="width: 500px" id="form-order-state-add">
        ...
        <script>
            $("#form-order-state-add").on('submit', (e) => {
                e.preventDefault();
                const data = {
                ...
                $.ajax({
                    ...
                    if (data?.detailMessage) {
                        ...
                        location.pathname = "/admin/order/state";
                    }
                })
            })
        </script>
