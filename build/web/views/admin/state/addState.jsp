        ...
        <div class="flex">
            ...
            <div class="w-full px-10 py-5">
                ...
                <div class="flex justify-center items-center" style="height: 80vh">
                    <form action="/admin/state/add" style="width: 500px" id="form-state-add">
                        ...
                        <div class="mb-6">
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">State name</label>
