            ...
            <div class="mt-10">
                <c:if test="${orders.size() <= 0}">
                    <div class="w-full min-h-[50vh] flex justify-center items-center">
                        <p class="text-5xl">YOU DO NOT HAVE ANY ORDER!</p>
                    </div>
                </c:if>
                        ...
                        <div class="overflow-x-auto shadow-md sm:rounded-lg">
                            <div class="inline-block min-w-full align-middle">
                                <div class="flex items-center p-4">
                                    <div>
                                        <span class="text-lg font-medium">Time: <fmt:formatDate pattern = "yyyy-MM-dd hh:mm:ss" value = "${order.created_at}"/></span>
                                    </div>
                                    <div class="ml-10">
                                        <span class="text-lg font-medium">Total: <span id="total-${order.id}">${order.total()}</span>
                                         <script>
                                    ...
                                    <div class="ml-auto">
                                        <span class="text-lg font-medium text-red-500">State: ${order.state.name}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
