        ...
        <nav class="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded">
            <div class="container flex flex-wrap justify-between items-center mx-auto">
                <a href="/" class="flex">
                    ...
                    <span class="self-center text-3xl font-semibold whitespace-nowrap dark:text-white">F-Cosmetics</span>
                </a>
                 <div>
                    <div class="container flex flex-wrap justify-between items-center mx-auto">
                        <form action="/products" method="GET" class="flex items-center flex-wrap">
                            <div class="relative mt-1 my-2 ">
                                ...
                                <input placeholder="Search for items" type="text" name="q" id="search" class="ml-3 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-100 sm:w-full pl-10 p-2.5">
                            </div>
                        </form>
                    </div>
                </div>
        ...
        <div class="bg-gray-100 w-full">
            <div class="flex justify-center items-center">
                <ul class="flex justify-center items-center flex-wrap" id="navGroupProduct">
                    <li class="relative">
                        <a href="/products" class="font-medium block py-4 px-6 nav-link hover:bg-gray-200 uppercase"><b>ALL</b></a>
                    </li>
...
<div class="transition duration-150 ease-in-out absolute top-[100%] left-[0] bg-gray-100 menuProductItem " style="display: none"> 
                                        ...
                                        <ul class="pt-2 px-2"> 
                                            ...
                                            <c:forEach items="${group.getCategories()}" var="category" begin="0" end="7" >                                                                                 
                                    ...
                                    <div class="transition duration-150 ease-in-out absolute top-[100%]  bg-gray-100 menuProductItem child" style="display: none"> 

                                        <ul class="pt-2 px-2"> 

                                            <c:forEach items="${group.getCategories()}" var="category" begin="8">                                                                                 
