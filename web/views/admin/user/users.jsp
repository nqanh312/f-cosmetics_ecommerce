...
<!--                                                <td class="p-4 w-4">
                                                ...
                                                <td class="py-4 px-6 text-sm font-medium text-center whitespace-nowrap">
                                                    ...
                                                    <a onclick="return confirm('Are you sure you want to delete this acount?');" href="/admin/users/delete?id=${user.getId()}" class="ml-3 text-red-600 hover:underline">Delete</button>
